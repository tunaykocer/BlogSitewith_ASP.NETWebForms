<%@ Page Title="" Language="C#" MasterPageFile="~/AltSayfa.Master" AutoEventWireup="true" CodeBehind="Blog.aspx.cs" Inherits="tunay.Blog" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="blog_left_sidebar">
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TunayMeenConnectionString %>" SelectCommand="SELECT * FROM [tblBlog] inner join tblBKategori on tblBKategori.id =tblBlog.KategoriId "></asp:SqlDataSource>
                        <asp:DataList ID="DataList1" runat="server" DataKeyField="id" DataSourceID="SqlDataSource2">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link">
                                    ...
                                    <li><a href="#"><i class="fa fa-comments"></i> 02 Yorum</a></li>
                                </ul>
                            </div>
                        </article>
                            </ItemTemplate>
