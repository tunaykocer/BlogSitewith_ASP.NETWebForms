...
{
    public partial class ResimKategori : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into tblResimKategori(Adi) values (@Adi)", baglanti);
            komut.Parameters.AddWithValue("@Adi", txtAd.Text.ToString());
            komut.ExecuteNonQuery();
            baglanti.Close();
            Response.Redirect("ResimKategori.aspx");
        }
    }
}